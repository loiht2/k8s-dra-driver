...
func (d *AllocatableDevice) PartGetDevice() resourceapi.Device {
	...
	case HAMiGpuDeviceType:
		// HAMi GPUs do not participate in the Partitionable Devices paradigm
		// (no MIG partitions, no shared counters). The legacy GetDevice()
		// returns a fully-populated Device with attributes and capacities.
